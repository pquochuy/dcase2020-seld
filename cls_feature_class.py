...
class FeatureClass:
    def __init__(self, params, is_eval=False):
        ...
        self._fs = params['fs']
        self._hop_len_s = params['hop_len_s'] # hop len in second
        self._hop_len = int(self._fs * self._hop_len_s) # hop len in samples

        self._label_hop_len_s = params['label_hop_len_s'] # hop len in seconds
    ...
    # get foa features fro linear spectrogram
