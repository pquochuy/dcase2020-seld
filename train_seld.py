        ...
        for epoch in range(scheduler['training_epoch']):
            ...
            while step < train_batches_per_epoch:
                ...
                if current_step % evaluate_every == 0:
                    ...
                    valid_loss_sed, valid_loss_doa, valid_output_loss, \
                    valid_total_loss, valid_score_sed, valid_score_doa = \
                        evaluate(gen=data_gen_valid, LR=applied_LR)
                    ...
                    # DCASE 2019 metric
                    valid_sed_metric, valid_doa_metric, valid_seld_metric = \
                        metric_dcase2019(data_gen_valid, valid_score_sed, valid_doa_pred)
                    test_sed_metric, test_doa_metric, test_seld_metric = \
                        metric_dcase2019(data_gen_test, test_score_sed, test_doa_pred)
                    ...
                    log_file("valid_metric.txt", valid_loss_sed, valid_loss_doa, valid_output_loss,
                             valid_sed_metric, valid_doa_metric,
                             valid_seld_metric, valid_new_metric, valid_new_seld_metric)
                    log_file("test_metric.txt", test_loss_sed, test_loss_doa, test_output_loss,
                             test_sed_metric, test_doa_metric,
                             test_seld_metric, test_new_metric, test_new_seld_metric)

                    print_metric(valid_sed_metric, valid_doa_metric,
                             valid_seld_metric, valid_new_metric, valid_new_seld_metric)
                    print_metric(test_sed_metric, test_doa_metric,
                             test_seld_metric, test_new_metric, test_new_seld_metric)
                    ...
                    if valid_new_seld_metric < best_valid_seld_metric:
                        ...
                        log_file("current_best_valid.txt", valid_loss_sed, valid_loss_doa, valid_output_loss,
                                 valid_sed_metric, valid_doa_metric,
                                 valid_seld_metric, valid_new_metric, valid_new_seld_metric)
                        log_file("current_best_test.txt", test_loss_sed, test_loss_doa, test_output_loss,
                                 test_sed_metric, test_doa_metric,
                                 test_seld_metric, test_new_metric, test_new_seld_metric)
